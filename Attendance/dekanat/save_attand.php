...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true || !isset($_SESSION['login_time']) || time() - $_SESSION['login_time'] >= 7200) {
    $redirect_url = 'dekanat/save_attand.php'; // URL текущей страницы, куда пользователь хотел перейти
...
<head>
    ...
    <title>Выгрузка посещаемости</title>
        ...
        $(document).ready(function() {
            ...
            $("#sendBtn").click(function() {
                ...
                if (groupId !== "" && starttimeId !== "" && endtimeId !== "") {
                    ...
                    var url = 'export_all_attandance.php?groupId=' + groupId + '&starttimeId=' + starttimeId + '&endtimeId=' + endtimeId;
...
if ($result->num_rows > 0) {
    ...
    echo '<select id="groups" name="groups" style="width: 100%;">';
