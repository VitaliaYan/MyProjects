...
// Получаем DgtID
$sqlDGT = "SELECT discgroupteacher.DgtID FROM discgroupteacher WHERE discgroupteacher.GroupID = '$groupId'";
...
if (!empty($dgtDisciplinePairs)){
    ...
    $sqlStudents = "SELECT * FROM `students` WHERE `GroupID` = '$groupId' AND students.Expelled = 0;";
